...
const HeaderConstrcutor = function ($rootScope) {
    ...
    this.updatePriceTicker = res => {
        ...
        if ($rootScope.currency.symbol !== 'G50' && (!$rootScope.currency.tickers || !$rootScope.currency.tickers.G50 || !$rootScope.currency.tickers.G50[$rootScope.currency.symbol])) {
            $rootScope.currency.symbol = 'G50';
        }
    };
